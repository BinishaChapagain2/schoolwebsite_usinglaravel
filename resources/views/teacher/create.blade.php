...
<div class="w-full px-4 py-4 bg-blue-900 shadow-md logo text-white flex justify-between">
    <div class="left items-center flex space-x-2">
      ...
      <span class="font-medium logo-name text-sm sm:text-base md:text-lg lg:text-xl">Add Teacher</span>
  </div>
@endsection
...
<div class="mx-auto">
    ...
    <form action="{{ route('teacher.store') }}" class="mt-8" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex justify-center gap-4 mt-10">
            <input type="submit" value="Add Teacher" class="px-6 py-3 font-semibold text-white bg-blue-900 rounded-lg hover:bg-blue-700 cursor-pointer">
